...
public class TransportIndexAction extends TransportWriteAction<IndexRequest, IndexRequest, IndexResponse> {
    ...
    @Override
    protected PrimaryOperationResult<IndexResponse> onPrimaryShard(IndexRequest request, IndexShard indexShard) throws Exception {
        return executeIndexRequestOnPrimary(request, indexShard, mappingUpdatedAction);
    }

    @Override
    protected ReplicaOperationResult onReplicaShard(IndexRequest request, IndexShard indexShard) {
