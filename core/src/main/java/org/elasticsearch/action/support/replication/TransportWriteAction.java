...
public abstract class TransportWriteAction<
     ...
     */
    protected abstract PrimaryOperationResult<Response> onPrimaryShard(Request request, IndexShard indexShard) throws Exception;
     ...
     */
    protected abstract ReplicaOperationResult onReplicaShard(ReplicaRequest request, IndexShard indexShard) throws Exception;

    @Override
    protected final WritePrimaryResult shardOperationOnPrimary(Request request, IndexShard primary) throws Exception {
        PrimaryOperationResult<Response> result = onPrimaryShard(request, primary);
    ...
    protected final WriteReplicaResult shardOperationOnReplica(ReplicaRequest request, IndexShard replica) throws Exception {
        ReplicaOperationResult result = onReplicaShard(request, replica);
        return result.success()
