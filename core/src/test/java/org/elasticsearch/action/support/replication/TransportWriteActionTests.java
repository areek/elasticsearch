...
public class TransportWriteActionTests extends ESTestCase {
    ...
    private class TestAction extends TransportWriteAction<TestRequest, TestRequest, TestResponse> {
        ...
        @Override
        protected PrimaryOperationResult<TestResponse> onPrimaryShard(TestRequest request, IndexShard indexShard) throws Exception {
            return new PrimaryOperationResult<>(new TestResponse(), location);
        }

        @Override
        protected ReplicaOperationResult onReplicaShard(TestRequest request, IndexShard indexShard) {
